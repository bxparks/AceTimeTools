...
#ifndef ACE_TIME_C_{self.db_header_namespace}_ZONE_POLICIES_H
#define ACE_TIME_C_{self.db_header_namespace}_ZONE_POLICIES_H
...
#ifndef ACE_TIME_C_{self.db_header_namespace}_ZONE_INFOS_H
#define ACE_TIME_C_{self.db_header_namespace}_ZONE_INFOS_H
...
"""
    ...
    def generate_infos_c(self) -> str:
        ...
        zone_and_link_string_size = zone_string_size + link_string_size
...
//   Names: {zone_string_size} (originally {zone_string_original_size})
//   Formats: {format_size}
//   Fragments: {fragment_size}
//   Memory (8-bit): {zone_memory8}
//   Memory (32-bit): {zone_memory32}
// kAtcZoneAndLinkRegistry sizes (bytes):
//   Names: {zone_and_link_string_size} \
(originally {zone_and_link_string_original_size})
//   Formats: {format_size}
//   Fragments: {fragment_size}
//   Memory (8-bit): {zone_and_link_memory8}
//   Memory (32-bit): {zone_and_link_memory32}
//
// DO NOT EDIT
...
#ifndef ACE_TIME_C_{self.db_header_namespace}_ZONE_REGISTRY_H
#define ACE_TIME_C_{self.db_header_namespace}_ZONE_REGISTRY_H
